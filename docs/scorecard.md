...
| --- | --- | --- |
| Is there a concrete Agent-to-Agent workflow? | `npm run agent:flow`, [architecture](architecture.md) | Complete (simulation) |
...
| Can a judge reproduce it quickly? | [judge guide](judge-guide.md) | Complete |
| Is the evidence honest? | LIVE_TESTNET/SIMULATION/DESIGN labels | Complete |

The remaining head-prize lift is presentation: show the policy decision before
each transaction and explain the FROZEN recovery boundary without claiming an
unaudited production system.
