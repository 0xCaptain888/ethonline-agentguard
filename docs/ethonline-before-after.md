...
| DeFiLlama-based YieldScout | Custom Arc task-index Subgraph makes seller history and settlement outcomes a provenance-bearing decision input | `subgraph/`, `src/ethonline/graph-agent.ts`, live observation JSON |
