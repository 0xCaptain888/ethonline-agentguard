...
const requiredFiles = [
  ...
  "docs/ethonline-form-copy.md",
  "docs/ethonline-v1.0.0-release.md",
  "docs/assets/ethonline-agentguard-architecture.svg",
  ...
  "scripts/run-privy-arc-failure-tasks.ts",
  "scripts/verify-live-failure-evidence.ts",
